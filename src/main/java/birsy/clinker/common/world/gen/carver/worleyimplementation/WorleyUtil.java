...
public class WorleyUtil {
    ...
    // Modified version of "SingleCellular2Edge(x, y, z)" from WorleyFastNoise
    ...
    public float SingleCellular3Edge(float x, float y, float z) {
        ...
        int xr = WorleyFastNoise.FastFloor(x)-1;
        int yr = WorleyFastNoise.FastFloor(y)-1;
        int zr = WorleyFastNoise.FastFloor(z)-1;
