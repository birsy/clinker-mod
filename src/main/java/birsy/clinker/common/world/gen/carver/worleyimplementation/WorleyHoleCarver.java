...
public class WorleyHoleCarver extends WorldCarver<ProbabilityConfig>
{
    ...
    public WorleyHoleCarver(Codec<ProbabilityConfig> config, int maxHeight, float size, float frequency1, float frequency2)
    {
