...
{		
	...
	public static final BaseTreeFeatureConfig LOCUST_TREE_CONFIG = (new BaseTreeFeatureConfig.Builder(
			...
			new PineFoliagePlacer(FeatureSpread.create(3), FeatureSpread.create(4), FeatureSpread.create(5)),
			new FancyTrunkPlacer(5, 2, 6),
			new TwoLayerFeature(4, 8, 4)))
			.setDecorators(ImmutableList.of(TrunkVineTreeDecorator.INSTANCE, LeaveVineTreeDecorator.field_236871_b_))
			.setIgnoreVines()
			.build();
