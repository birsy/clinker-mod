...
public class SurfaceDecorationHelpers {
    ...
    public static boolean steepnessThreshold(
            ...
            NoiseSampler sampler, double scale, double offset,
            double minRange,
            double maxRange,
            int minThreshold,
            int maxThreshold
        ...
        int threshold = (int) Math.round(Mth.clampedMap(
                sampler.sample(pos.getX() * scale, offset, pos.getZ() * scale),
                minRange, maxRange,
    ...
    public static boolean noiseInThreshold(
        ...
        double noise = noiseWithDither(pos, ctx, sampler, scale, offset, ditherAmount);
    ...
    public static boolean noiseAbove(
        ...
        return noiseWithDither(pos, ctx, sampler, scale, offset, ditherAmount) > threshold;
    }
    ...
    public static double noiseWithDither(
        ...
        double noise = sampler.sample(pos.getX() * scale, offset, pos.getZ() * scale);
