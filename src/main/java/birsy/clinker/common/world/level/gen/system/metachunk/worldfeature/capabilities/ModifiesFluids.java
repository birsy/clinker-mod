...
public interface ModifiesFluids extends WorldFeatureCapability {
    ...
    FluidLevel modifyFluidLevel(int x, int y, int z, int minX, int minY, int minZ, FluidLevel currentFluidLevel, NoiseContext context, InterpolatingField heightmap);
}
