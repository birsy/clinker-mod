...
public abstract class TerrainProvider {
    public abstract float sample(WorldGenLevel level, ChunkAccess chunk, long seed, double x, double y, double z, NoiseSampler sampler) throws ExecutionException;
