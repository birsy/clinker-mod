...
public abstract class AbstractBrambleBodyBlock extends GrowingPlantBodyBlock implements net.minecraftforge.common.IForgeShearable
{	
	public static final VoxelShape SHAPE = Block.box(4.0D, 0.0D, 4.0D, 12.0D, 16.0D, 12.0D);
	
	public AbstractBrambleBodyBlock(BlockBehaviour.Properties properties, Direction growthDirection) {
