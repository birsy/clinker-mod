...
import birsy.clinker.common.item.components.OrdnanceEffects;
...
//                );
    ...
    public static void createOrdnanceExplosion(Vec3 location, Level level, @Nullable Entity thrower, @Nullable OldOrdnanceEntity ordnance, OrdnanceEffects effects) {
        float radius = 5F;
