...
public class MogulWeaponModels {
    public static final ResourceLocation WARHOOK_LOCATION = new ResourceLocation(Clinker.MOD_ID, "textures/entity/mogul_warhook.png");
    public static final ResourceLocation WARHOOK_CHAIN_LOCATION = new ResourceLocation(Clinker.MOD_ID, "textures/entity/mogul_warhook_chain.png");
