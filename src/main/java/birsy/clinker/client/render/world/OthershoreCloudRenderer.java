...
public class OthershoreCloudRenderer {
    ...
    private static final ResourceLocation FOG_FADE_TEXTURE = new ResourceLocation(Clinker.MOD_ID, "textures/environment/fog.png");
    ...
    public void render(ClientLevel level, int ticks, float partialTick, PoseStack poseStack, double camX, double camY, double camZ, Matrix4f projectionMatrix) {
        ...
        float radius = (Minecraft.getInstance().options.getEffectiveRenderDistance()+1) * 16;
        ...
        for (int i = layers - 1; i >= 0; i--) {
            ...
            setShaderUniform(shader, "Depth", (float) i / layers);
