...
public class LesserShoggothHeadModel<T extends Entity> extends BirsyBaseModel<T> {
    ...
    public LesserShoggothHeadModel() {
        ...
        this.shoggothEye.setRotationPoint(0.0F, -18.0F, -1.0F);
        ...
        this.shoggothHead.setRotationPoint(0.0F, -11.0F, 0.0F);
        ...
        this.headJoint.setRotationPoint(0.0F, 0.0F, 0.0F);
        ...
        this.shoggothMouth.setRotationPoint(5.0F, -5.0F, 2.0F);
