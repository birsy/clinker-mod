...
public class HeatedCauldronModel extends Model {
    ...
    public HeatedCauldronModel() {
        ...
        this.cauldronNorthEastLegA.setPos(8.0F, 0.0F, 8.0F);
        ...
        this.cauldronEastWall.setPos(0.0F, -3.0F, 0.0F);
        ...
        this.cauldronNorthWestLeg.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.cauldronNorthWestLegA.setPos(-8.0F, 0.0F, 8.0F);
        ...
        this.cauldronNorthWall.setPos(0.0F, -3.0F, 0.0F);
        ...
        this.cauldronSouthWestLegA.setPos(-8.0F, 0.0F, -8.0F);
        ...
        this.cauldronSouthEastLegA.setPos(8.0F, 0.0F, -8.0F);
        ...
        this.cauldronWestWall.setPos(0.0F, -3.0F, 0.0F);
        ...
        this.cauldronSouthWestLeg.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.cauldronFloor.setPos(0.0F, -3.0F, 0.0F);
        ...
        this.cauldronNorthEastLegB.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.cauldronSouthEastLegB.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.cauldronBase.setPos(0.0F, 24.0F, 0.0F);
        ...
        this.cauldronSouthWall.setPos(0.0F, -3.0F, 0.0F);
    ...
    public void setSpoonRotation(float rotationInDegrees) {
        this.cauldronSpoonHandle.yRot = (float) Math.toRadians(rotationInDegrees);
    }
    ...
    public void setItemRotations(float rotationInDegrees0, float rotationInDegrees1, float rotationInDegrees2, float rotationInDegrees3) {
        this.item0Base.yRot = (float) Math.toRadians(rotationInDegrees0);
        this.item1Base.yRot = (float) Math.toRadians(rotationInDegrees1);
        this.item2Base.yRot = (float) Math.toRadians(rotationInDegrees2);
        this.item3Base.yRot = (float) Math.toRadians(rotationInDegrees3);
    }
    ...
    public void setCauldronShake (float shakeAmount, float ageInTicks) {
        this.cauldronBase.xRot = (Mth.sin(ageInTicks) * 0.02F) * shakeAmount;
        this.cauldronBase.zRot = (Mth.cos(ageInTicks) * 0.02F) * shakeAmount;
    }
}
