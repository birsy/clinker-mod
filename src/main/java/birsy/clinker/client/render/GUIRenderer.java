...
public class GUIRenderer {
    ...
    public static void onRenderGUI(RenderGuiEvent.Post event) {
        //zosimusRenderer.render(event.getGuiGraphics().pose(), Minecraft.getInstance().levelRenderer.getTicks() + event.getPartialTick().getGameTimeDeltaTicks(), event.getPartialTick().getGameTimeDeltaTicks());
