...
public class GnomadAxemanRenderer extends ClinkerEntityRenderer<OldGnomadAxemanEntity, GnomadAxemanDynamicModel<OldGnomadAxemanEntity>> {
    private static final ResourceLocation[] GNOMAD_AXEMAN_LOCATIONS = Util.make(new ResourceLocation[OldGnomadAxemanEntity.VARIANT_AMOUNT], (array) -> {
    ...
    @Override
    public void render(OldGnomadAxemanEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
     ...
     */
    public ResourceLocation getTextureLocation(OldGnomadAxemanEntity entity) {
