...
public class ComplexModelPart {
    ...
    public SecondOrderDynamics xRot;
    public SecondOrderDynamics yRot;
    public SecondOrderDynamics zRot;
    public SecondOrderDynamics xScale;
    public SecondOrderDynamics yScale;
    public SecondOrderDynamics zScale;
    public float xInit;
    public float yInit;
    public float zInit;
    ...
    public ComplexModelPart(List<ModelPart.Cube> pCubes, PartPose pose) {
        this(pose, pCubes);
    }

    public ComplexModelPart(PartPose pose, List<ModelPart.Cube> pCubes) {
        this(pCubes);
    ...
    public ComplexModelPart(List<ModelPart.Cube> pCubes) {
        this.cubes = pCubes;
    }
