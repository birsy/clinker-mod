...
public class MudScarabRenderer extends InterpolatedEntityRenderer<MudScarabEntity, FrogNoMoreSkeletonFactory.FrogNoMoreModel> {
    ...
    private static final ResourceLocation SCARAB_LOCATION = new ResourceLocation(Clinker.MOD_ID, "textures/entity/frog_no_more.png");
