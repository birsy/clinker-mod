...
public class NewGnomadRenderer extends InterpolatedEntityRenderer<NewGnomadEntity, PlaceholderGnomadSkeletonFactory.PlaceholderGnomadSkeleton> {
    ...
    @Override
    public void render(NewGnomadEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack poseStack, MultiBufferSource pBuffer, int pPackedLight) {
        poseStack.pushPose();
    ...
    @Override
    public void renderModel(NewGnomadEntity pEntity, float pPartialTicks, PoseStack poseStack, MultiBufferSource pBuffer, int pPackedLight) {
    ...
    public RenderType getRenderType(NewGnomadEntity entity) {
        return RenderType.entityCutoutNoCull(this.getTextureLocation(entity));
    }

    public ResourceLocation getTextureLocation(NewGnomadEntity entity) {
