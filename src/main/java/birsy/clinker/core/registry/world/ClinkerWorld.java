...
public class ClinkerWorld {
    ...
    public static final ResourceKey<Level> OTHERSHORE = ResourceKey.create(Registries.DIMENSION, new ResourceLocation(Clinker.MOD_ID, "othershore"));
    ...
    public static final Supplier<Codec<TerrainBuilderTestChunkGenerator>> TERRAIN_BUILDER_TEST_CHUNK_GENERATOR = CHUNK_GENERATORS.register("terrain_builder_test_chunk_generator", () -> TerrainBuilderTestChunkGenerator.CODEC);
