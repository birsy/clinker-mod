...
public class ClinkerItems
{
	...
	public static final RegistryObject<Item> LEAD_INGOT = ITEMS.register("lead_ingot", () -> new Item(new Item.Properties().tab(Clinker.CLINKER_MISC)));
	...
	public static final RegistryObject<Item> BRINE_BUCKET = ITEMS.register("brine_bucket", () -> new BucketItem(
			ClinkerFluids.BRINE_SOURCE, (new Item.Properties()).tab(Clinker.CLINKER_MISC).stacksTo(1)));
	//Projectiles
	...
	public static final RegistryObject<ClinkerSpawnEggItem> SHOGGOTH_SPAWN_EGG = ITEMS.register("shoggoth_spawn_egg",
			() -> new ClinkerSpawnEggItem(ClinkerEntities.SHOGGOTH_HEAD, 0x85494C, 0x6E7058, new Item.Properties().tab(Clinker.CLINKER_MISC)));

	public static final RegistryObject<ClinkerSpawnEggItem> SNAIL_SPAWN_EGG = ITEMS.register("snail_spawn_egg",
	() -> new ClinkerSpawnEggItem(ClinkerEntities.SNAIL, 0x85494C, 0x6E7058, new Item.Properties().tab(Clinker.CLINKER_MISC)));

	public static final RegistryObject<ClinkerSpawnEggItem> BOX_BEETLE_SPAWN_EGG = ITEMS.register("box_beetle_spawn_egg",
	() -> new ClinkerSpawnEggItem(ClinkerEntities.BOX_BEETLE, 0x1d1d23, 0x6b715d, new Item.Properties().tab(Clinker.CLINKER_MISC)));

	public static final RegistryObject<ClinkerSpawnEggItem> GNOME_SPAWN_EGG = ITEMS.register("gnome_spawn_egg",
	() -> new ClinkerSpawnEggItem(ClinkerEntities.GNOME, 0x735d57, 0x763a3e, new Item.Properties().tab(Clinker.CLINKER_MISC)));
	
	public static final RegistryObject<ClinkerSpawnEggItem> GNOMAD_AXEMAN_SPAWN_EGG = ITEMS.register("gnomad_axeman_spawn_egg",
	() -> new ClinkerSpawnEggItem(ClinkerEntities.GNOMAD_AXEMAN, 0x36322c, 0x897b75, new Item.Properties().tab(Clinker.CLINKER_MISC)));
	
	public static final RegistryObject<ClinkerSpawnEggItem> GNOMAD_SHAMAN_SPAWN_EGG = ITEMS.register("gnomad_shaman_spawn_egg",
	() -> new ClinkerSpawnEggItem(ClinkerEntities.GNOMAD_SHAMAN, 0x544950, 0x897b75, new Item.Properties().tab(Clinker.CLINKER_MISC)));
	
	public static final RegistryObject<ClinkerSpawnEggItem> COPTER_GNOMAD_SPAWN_EGG = ITEMS.register("copter_gnomad_spawn_egg",
	() -> new ClinkerSpawnEggItem(ClinkerEntities.COPTER_GNOMAD, 0x36322c, 0x897b75, new Item.Properties().tab(Clinker.CLINKER_MISC)));	
	
	public static final RegistryObject<ClinkerSpawnEggItem> HYENA_SPAWN_EGG = ITEMS.register("hyena_spawn_egg",
	() -> new ClinkerSpawnEggItem(ClinkerEntities.HYENA, 0x735d57, 0x763a3e, new Item.Properties().tab(Clinker.CLINKER_MISC)));
	
	public static final RegistryObject<ClinkerSpawnEggItem> WITCH_BRICK_SPAWN_EGG = ITEMS.register("witch_brick_spawn_egg",
	() -> new ClinkerSpawnEggItem(ClinkerEntities.WITCH_BRICK, 0x9aa8af, 0x593025, new Item.Properties().tab(Clinker.CLINKER_MISC)));
	...
	new LeadArmorItem(EquipmentSlot.HEAD));
	
	public static final RegistryObject<ArmorItem> LEAD_CHESTPLATE = ITEMS.register("lead_chestplate", () ->
	new LeadArmorItem(EquipmentSlot.CHEST));
	
	public static final RegistryObject<ArmorItem> LEAD_LEGGINGS = ITEMS.register("lead_leggings", () ->
	new ArmorItem(ClinkerArmorMaterial.LEAD, EquipmentSlot.LEGS, new Item.Properties().tab(Clinker.CLINKER_TOOLS)));
	
	public static final RegistryObject<ArmorItem> LEAD_BOOTS = ITEMS.register("lead_boots", () ->
	new ArmorItem(ClinkerArmorMaterial.LEAD, EquipmentSlot.FEET, new Item.Properties().tab(Clinker.CLINKER_TOOLS)));
	
	//Shell Armor
	public static final RegistryObject<ArmorItem> SHELL_HELMET = ITEMS.register("shell_helmet", () ->
	new ArmorItem(ClinkerArmorMaterial.SHELL, EquipmentSlot.HEAD, new Item.Properties().tab(Clinker.CLINKER_TOOLS)));
	
	public static final RegistryObject<ArmorItem> SHELL_CHESTPLATE = ITEMS.register("shell_chestplate", () ->
	new ArmorItem(ClinkerArmorMaterial.SHELL, EquipmentSlot.CHEST, new Item.Properties().tab(Clinker.CLINKER_TOOLS)));
	
	public static final RegistryObject<ArmorItem> SHELL_LEGGINGS = ITEMS.register("shell_leggings", () ->
	new ArmorItem(ClinkerArmorMaterial.SHELL, EquipmentSlot.LEGS, new Item.Properties().tab(Clinker.CLINKER_TOOLS)));
	
	public static final RegistryObject<ArmorItem> SHELL_BOOTS = ITEMS.register("shell_boots", () ->
	new ArmorItem(ClinkerArmorMaterial.SHELL, EquipmentSlot.FEET, new Item.Properties().tab(Clinker.CLINKER_TOOLS)));
	
	public static final RegistryObject<ShieldItem> SHELL_SHIELD = ITEMS.register("shell_shield", () ->
	new ShieldItem(new Item.Properties().tab(Clinker.CLINKER_TOOLS)));
	
	//Traditional Armor
	public static final RegistryObject<ArmorItem> TRADITIONAL_ROBES = ITEMS.register("traditional_robes", () ->
	new ArmorItem(ClinkerArmorMaterial.TRADITIONAL, EquipmentSlot.CHEST, new Item.Properties().tab(Clinker.CLINKER_TOOLS)));
	
	public static final RegistryObject<ArmorItem> TRADITIONAL_PANTS = ITEMS.register("traditional_pants", () ->
	new ArmorItem(ClinkerArmorMaterial.TRADITIONAL, EquipmentSlot.LEGS, new Item.Properties().tab(Clinker.CLINKER_TOOLS)));
	
	public static final RegistryObject<ArmorItem> TRADITIONAL_SHOES = ITEMS.register("traditional_shoes", () ->
	new ArmorItem(ClinkerArmorMaterial.TRADITIONAL, EquipmentSlot.FEET, new Item.Properties().tab(Clinker.CLINKER_TOOLS)));
}
