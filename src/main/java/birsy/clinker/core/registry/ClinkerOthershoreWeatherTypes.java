...
public class ClinkerOthershoreWeatherTypes {
    ...
    public static final DeferredHolder<OthershoreWeather.Type, OthershoreWeather.Type> NORMAL =
    ...
    public static final DeferredHolder<OthershoreWeather.Type, OthershoreWeather.Type> STORM_APPROACHING =
    ...
    public static final DeferredHolder<OthershoreWeather.Type, OthershoreWeather.Type> STORM =
            OTHERSHORE_WEATHER_TYPES.register("storm", () -> new OthershoreWeather.Type(
                    (system) -> new StormWeather(),
                    StormWeather.CODEC,
