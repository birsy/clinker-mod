...
public class Quaterniond implements Externalizable, Cloneable {
    ...
    public Quaterniond(AxisAngle aa) {
    ...
    public AxisAngle get() {
        ...
        if (s < 0.001) {
            return new AxisAngle(new Vec3(x, y, z), (2.0 * Math.acos(w)));
        } else {
            s = 1.0 / s;
            return new AxisAngle(new Vec3(x * s, y * s, z * s), (2.0 * Math.acos(w)));
        }
    }
     ...
     * @return this
     */
    public Quaterniond set(AxisAngle axisAngle) {
     ...
     * axis, all of which are specified via the {@link AxisAngle}.
     *
     * @see #rotationAxis(double, double, double, double)
     *
     * @param axisAngle
     *            the {@link AxisAngle} giving the rotation angle in radians and the axis to rotate about
     * @return this
     */
    public Quaterniond rotationAxis(AxisAngle axisAngle) {
