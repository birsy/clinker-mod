...
void main() {
    ...
    float maxYOffset = 10;
    float yOffset = -(cloudDensity * 2 - 1) * maxYOffset;
    center += vec3(0, 270 + yOffset, 0);
    ...
    float cloudBrightness = mix(cloudDensity, smoothstep(280 + radius + maxYOffset, 280 - radius - maxYOffset, worldPos.y), 0.5);
